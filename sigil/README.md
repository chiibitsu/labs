...
> **Live at [labs.chiibitsu.com/sigil/](https://labs.chiibitsu.com/sigil/)** — or open
...
```
https://labs.chiibitsu.com/sigil/?seed=ada
https://labs.chiibitsu.com/sigil/?seed=your-name-here
```
...
**Hosting:** this folder is published as part of the
[Chiibitsu Labs](../README.md) hub on GitHub Pages, so it's live at
`labs.chiibitsu.com/sigil/`. Every cosmos is a public, shareable URL.
...
dependencies; regenerate it any time (run from this `sigil/` folder):

```bash
node scripts/gen-og.js
```

The social tags in `index.html` point at `labs.chiibitsu.com/sigil/`. If you
ever move it, update the `og:url` / `og:image` values near the top of the file.
